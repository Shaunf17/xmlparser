...
namespace XmlParserThing
{
    class Program
    {
            ...
            while (reader.Read())
            {
                    ...
                    (reader.NodeType == XmlNodeType.Element))
                {
                    ...
                    if (reader.GetAttribute("type") != null)
                    {
                        ...
                        ProcessPlayEvent(title, reader, reader.GetAttribute("type"), content);
                    }
                    else
                    {
                        reader.Skip();
        ...
        static void ProcessPlayEvent(string title, XmlTextReader reader, string attr, List<Content> content)
        {
            TimeSpan ts;
            string[] contentTitle;
